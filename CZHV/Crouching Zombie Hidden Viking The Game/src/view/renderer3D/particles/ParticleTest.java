...
public class ParticleTest {
	...
	public ParticleTest() {
		...
		test = new ColoredDirectionalEmitter(10000, 20, 10, 100, new Drawable3D[] {new TriangleParticle(0.02f)}, new Vector3f(1,0.1f,1), new Vector3f(0,0.001f,0), new Vector3f(0,0.00002f,0), 0.8f, 0.05f, gradient);
		//test = new DirectionalEmitter(10000, 10, 50, 50, new Drawable3D[] {new TriangleParticle(0.01f)}, new Vector3f(1,0.1f,1), new Vector3f(0,0.001f,0), new Vector3f(0,0.00001f,0), 0.8f, 0.05f);
	}
